...
def handle_original_cluster():
    run_ansible_playbook("1_original_cluster.yml")

@socketio.on("sample_data")
def handle_sample_data():
    run_ansible_playbook("2_restore_snapshot.yml")

@socketio.on("start_stress")
def handle_start_stress():
    run_ansible_playbook("3_stress.yml")

@socketio.on("scale_out")
def handle_scale_out():
    run_ansible_playbook("4_scale_out.yml")

@socketio.on("stop_stress")
def handle_stop_stress():
    run_ansible_playbook("5_stop_stress.yml")

@socketio.on("scale_in")
def handle_scale_in():
    run_ansible_playbook("6_scale_in.yml")
